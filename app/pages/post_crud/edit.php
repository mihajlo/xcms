...
if (isset($_POST['user_id']) && isset($_POST['alias']) && isset($_POST['title']) && isset($_POST['description']) && isset($_POST['body']) && isset($_POST['categories']) && isset($_POST['tags']) && isset($_POST['comments_active']) && isset($_POST['created']) && isset($_POST['updated']) && isset($_POST['photo']) && $url->segment(3)) {
