...
if (isset($_POST['type']) && isset($_POST['username']) && isset($_POST['password']) && isset($_POST['display_name']) && isset($_POST['email']) && isset($_POST['created']) && isset($_POST['updated']) && isset($_POST['active']) && isset($_POST['banned'])) {
