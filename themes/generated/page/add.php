...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <?php }?>
            <form role="form" method="post" action="<?php echo $url->site_url('page/add') ?>">
                
                <div class="form-group">
                    <label for="parent">Page type:</label>
                    <select name="type" id="type" class="form-control">
                        <?php foreach($config['page_types'] as $p_key=>$p_value){?>
                        <option value="<?=$p_key;?>" <?php if($p_key==@$_POST['type']){echo 'selected="selected"';} ?>><?=$p_value;?></option>
                        <?php }?>
                    </select>
                </div>
                ...
                <div class="form-group parent_container">
                    ...
                    <select name="parent" class="form-control">
                        ...
                        <option value="<?=$parent['_id'];?>" <?php if(@$_POST['parent']==$parent['_id']){ echo 'selected="selected"';}?>><?=$parent['title'].' ('.$parent['alias'].')';?></option>
                        <?php }?>
                    </select>
                </div>
                <div class="form-group categories_container">
                    ...
                    <select multiple name="categories[]" id="categories" class="form-control">
                        ...
                        <option value="<?=$cat['_id'];?>" <?php if(in_array($cat['_id'],@$_POST['categories'])){echo 'selected="selected"';} ?>><?=$cat['name'];?></option>
                        <?php }?>
                    </select>
                ...
                <div class="form-group tags_container">
                    ...
                    <select multiple name="tags[]" id="tags" class="form-control">
                        ...
                        <option value="<?=$tag['name'];?>" <?php if(in_array($tag['name'],@$_POST['tags'])){echo 'selected="selected"';} ?>><?=$tag['name'];?></option>
                        <?php }?>
                    </select>
                </div>
                <div class="form-group">
                    <label for="title">Title:</label>
                    <input type="text" class="form-control" onkeyup="document.getElementById('alias').value=this.value.toLowerCase().replace(/ /g,'-').replace(/[^\w-]+/g,'');" id="title" name="title" value="<?php echo @$_POST['title'];?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea rows="15" class="form-control" id="body" name="body" ><?php echo @$_POST['body'];?></textarea>
                </div><div class="form-group">
                    ...
                    <input type="hidden" class="form-control" id="photo" name="photo" value="<?php echo @$_POST['photo'];?>">
                    <script>
                ...
                <div class="form-group comments_allowed_container">
                    <label for="comments">Comments allowed:</label>
                        <select class="form-control" id="comments_allowed" name="comments_allowed">
                            ...
                            <option value="0" <?php if(@$_POST['comments_allowed']){}else{echo 'selected="selected"';}?>>No</option>
                    </select>
                ...
                <div class="form-group private_container">
                    <label for="private">Private page:</label>
                        <select class="form-control" id="private" name="private">
                            ...
                            <option value="1" <?php if(@$_POST['private']){echo 'selected="selected"';}?>>Yes</option>
                    </select>
                ...
                <div class="form-group active_container">
                    ...
                    <select class="form-control" id="active" name="active">
                            <option value="1">Yes</option>
                            <option value="0" <?php if(isset($_POST['active']) && !@$_POST['active']){echo 'selected="selected"';}?>>No</option>
                    </select>
