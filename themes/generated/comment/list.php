...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <hr>
            <a href="<?php echo $url->site_url('comment/add'); ?>" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-plus"></span> Add comment</a>
            ...
            <?php if (count($comments) > 0) { ?>
                ...
                <table class="table table-striped" id="comment_results">
                    <thead>
                        ...
                        <tr>
                            <th>_id</th>
                                                        <th>user_id</th>                            <th>url</th>                            <th>comment</th>                            <th>created</th>
                            <th>Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php foreach ($comments as $comment) { ?>
                            <tr>
                                <td><?php echo $comment['_id']; ?></td>
                                                                <td><?php echo $comment['user_id']; ?></td>                            <td><?php echo $comment['url']; ?></td>                            <td><?php echo $comment['comment']; ?></td>                            <td><?php echo $comment['created']; ?></td>
