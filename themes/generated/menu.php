  ...
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <ul class="nav navbar-nav">
        ...
        <li <?php if($url->segment(1)=='logout'){echo 'class="active"';}?>><a href="<?=$url->site_url('logout'); ?>"><span class="glyphicon glyphicon-log-out"></span> Logout [<?=@$_SESSION['logged_in']['display_name'];?>]</a></li>
