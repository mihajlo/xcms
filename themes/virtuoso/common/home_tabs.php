                            ...
                            <div class="tabs-dark" style="padding:0;">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade in active" id="home">
                                        <img style="float: left; margin-right: 25px; margin-bottom: 10px;" src="<?=$url->site_url($config['theme_path'].'assets/img/frontpage/filler1.jpg');?>" alt="filler image">
                                    ...
                                    <div class="tab-pane fade" id="profile">
                                        <img style="float: left; margin-right: 25px; margin-bottom: 10px;" src="<?=$url->site_url($config['theme_path'].'assets/img/frontpage/filler2.jpg');?>" alt="filler image">
                                    ...
                                    <div class="tab-pane fade" id="messages">
                                        <img style="float: left; margin-right: 25px; margin-bottom: 10px;" src="<?=$url->site_url($config['theme_path'].'assets/img/frontpage/filler3.jpg');?>" alt="filler image">
